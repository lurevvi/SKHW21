...
class PetFriends:
    ...
    def get_api_key(self, email: str, passwd: str) -> json:
        ...
        log_dict = {
            "Headers of query": headers,
            "Path parametrs": None,
            "Query parametrs": filter,
            "Query body": res.request.body,
            "Content": res.headers,  # обязательные заголовки
            "Optional": res.request.headers,  # опциональные заголовки
            "URL": res.request.url,
            "Path URL": res.request.path_url,
            "Cookie": res.cookies,
        }
        return status, result, log_dict
